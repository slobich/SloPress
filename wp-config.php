...
/**
* Define MySQL settings for local development.
...
if ( file_exists( dirname( __FILE__ ) . '/local-config.php' ) ) {
	...
	define( 'DB_NAME', 'database_name_here' ); // The name of the database for WordPress
...
/**
* Define where WordPress core files reside and website URL.
